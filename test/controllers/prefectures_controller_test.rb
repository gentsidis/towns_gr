...
class PrefecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prefecture" do
    assert_difference('Prefecture.count') do
      post prefectures_url, params: { prefecture: { name: @prefecture.name, region_id: @prefecture.region_id } }
    end
  ...
  test "should update prefecture" do
    patch prefecture_url(@prefecture), params: { prefecture: { name: @prefecture.name, region_id: @prefecture.region_id } }
